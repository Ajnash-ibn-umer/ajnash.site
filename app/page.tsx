  ...
  return (
    <div className="min-h-screen bg-[#f5f1eb] px-6 py-12 md:px-12 lg:px-24">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif italic text-gray-800 leading-tight">
            ...
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              ...
              <p>
                I've collaborated with diverse industries, creating solutions
                that leave a lasting impact and drive growth.
              </p>
            ...
            <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-gray-200 max-w-sm">
              <div className="text-center space-y-4">
                <div className="w-24 h-24 bg-gray-300 rounded-full mx-auto flex items-center justify-center">
                   ...
                   */}
                  <img src="/cartoon-profile.png" alt="" />
                </div>
                <div>
        ...
        {/* Services Section */}
        <div className="mt-16">
          <h2 className="text-3xl font-serif italic text-gray-800 mb-8">
            What I'm Doing
          </h2>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Building robust, secure, and scalable systems to power your
                    applications.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-gray-200">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Designing and optimizing cloud solutions for reliability and
                    performance.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-gray-200">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Creating scalable, maintainable architectures tailored to
                    your goals.
                  </p>
                </div>
              </div>
